...
default_model_weights = '{}/snapshot_models/YOLO_VOC0712/voc_model_iter_30000.caffemodel'.format(CF_tool_root)
...
def main(args):
    '''main '''
    job_name = "YOLO_{}_{}x{}".format(args.gen_dir, args.image_resize, args.image_resize)
