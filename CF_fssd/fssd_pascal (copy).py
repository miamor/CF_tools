...
train_data = "{}/lmdb/VOC0712_trainval_lmdb".format(CF_tool_root)
# The database file for testing data. Created by data/VOC0712/create_data.sh
test_data = "{}/lmdb/VOC0712_test_lmdb".format(CF_tool_root)
...
job_name = "FSSD_tutu_{}".format(resize)
...
name_size_file = "{}/data/VOC0712/ssd/test_name_size.txt".format(CF_tool_root)
...
# Stores LabelMapItem.
#label_map_file = "{}/data/VOC0712/labelmap_voc.prototxt".format(CF_tool_root)
label_map_file = "{}/data/VOC0712/ssd/label_map.txt".format(CF_tool_root)
