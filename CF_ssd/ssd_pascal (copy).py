...
def main(args):
    ...
    job_name = "SSD_{}_{}".format(args.gen_dir, resize)
    ...
    name_size_file = "{}/data/{}/{}/test_name_size.txt".format(CF_tool_root, args.gen_dir, __model)
    ...
    #label_map_file = "{}/data/{}/label_map.txt".format(CF_tool_root, args.gen_dir)
...
def parse_args():
    ...
    parser.add_argument('--gen_dir', default='VOC0712')
    parser.add_argument('--image_resize', default=300, type=int)
    parser.add_argument('--model_weights',
                        default='snapshot_models/SSD_300x300/VGG_VOC0712_SSD_300x300_iter_120000.caffemodel')
    parser.add_argument('--labelmap_file',
                        default='data/VOC0712/ssd/label_map.txt')
