...
default_job_name = "SSD_tutu_300x300"
...
run_soon = True
# The video file path
default_video_file = "{}/images/ILSVRC2015_train_00755001.mp4"
...
def main(args):
    ...
    job_name = "SSD_{}_{}x{}".format(args.gen_dir, args.image_resize, args.image_resize)
...
def parse_args():
    ...
    parser.add_argument('--video_file', default=default_video_file)
